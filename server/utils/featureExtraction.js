 ...
 */
function extractAttemptFeatures({
  samples,
  spawnTms,
  clickTms,
  target,
 ...
 */
function extractBatchFeatures(attempts, allSamples) {
 ...
 */
function normalizeRadius(radiusPx, screenWidth, screenHeight) {
 ...
 */
function normalizeSpeed(speedPxPerSec, screenWidth, screenHeight) {
  const minDim = Math.min(screenWidth, screenHeight);
