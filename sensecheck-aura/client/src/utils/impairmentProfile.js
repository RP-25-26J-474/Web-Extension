...
const AURA_API_BASE_URL = import.meta.env.VITE_API_URL || 'https://api-gateway.auraui.org/api';
...
export const buildAndSaveImpairmentProfile = async (params) => {
  ...
  if (auraIntegration.isEnabled()) {
    try {
      ...
      const auraAPI = `${import.meta.env.VITE_API_URL || 'https://api-gateway.auraui.org/api'}/onboarding`;
